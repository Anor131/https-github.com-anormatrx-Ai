          ...
          <header className="flex h-16 items-center justify-between border-b border-white/5 bg-white/2 px-6 backdrop-blur-sm">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 rounded-full bg-cyan-500/10 px-3 py-1 border border-cyan-500/20">
                ...
                <span className="text-[10px] font-mono text-cyan-400/80">حالة النظام: مثالية</span>
              </div>
            </div>

            <div className="flex items-center gap-4">
              <div className="hidden md:flex items-center gap-6 text-[10px] font-mono text-white/40">
                <span>المعالج: 12%</span>
                <span>الرسوميات: 8%</span>
                <span>الاستجابة: 4ms</span>
              </div>
          ...
          <div className="flex-1 overflow-hidden p-6">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {!["dashboard", "chat", "model-connect", "lab", "openclaw", "forge"].includes(activeModule) && (
